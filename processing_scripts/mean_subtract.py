...
for i in range(n_files):
    if os.path.exists(out_path+meta.loc[i, 'brain']+"_p05_norm_subtracted.tif"):
        print(meta.loc[i, 'brain']+"_p05_norm_subtracted.tif", "already exists")
    else:
        ...
        print(out_path+meta.loc[i, 'brain']+"_p05_norm_subtracted.tif")
